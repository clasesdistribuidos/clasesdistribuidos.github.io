...
El diálogo completo, dicho como si los dos hablaran, es este. El nodo pregunta "¿hay trabajo para mí?", y el coordinador contesta "sí: vas a ser un mapper, este es tu input y tenés que generar dos salidas". Ese nodo ejecuta la función map, genera sus dos archivos y los deja donde están. Después avisa: "ya terminé, soy el mapper 1". Cuando el coordinador ve que todos terminaron, toma un nodo y le dice "ahora sos el reducer 1, tenés que ir a buscar todos estos archivos" —el `M1_R1`, el `M2_R1`, y así sucesivamente—. E incluso, si ese reducer falla, le va a decir a otro "ahora sos el reducer 1".
