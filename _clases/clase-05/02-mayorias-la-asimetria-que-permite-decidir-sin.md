...
También es común que haya particiones de red entre data centers, porque están conectados por fibra óptica. Un caso típico: una obra entre dos data centers corta con una amoladora el cable de fibra que los une. Aunque haya rutas redundantes, perder un enlace puede degradar tanto la comunicación que el data center queda prácticamente fuera de servicio.
