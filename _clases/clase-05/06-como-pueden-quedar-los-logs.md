...
<figure class="figura figura-con-imagen">
  <img src="{{ '/assets/clase-05/logs-iguales.png' | relative_url }}" alt="Logs de tres servidores con los mismos términos">
  <figcaption>
...
<figure class="figura figura-con-imagen">
  <img src="{{ '/assets/clase-05/replicacion-con-falla.png' | relative_url }}" alt="El líder replica dos entradas y la segunda no llega a un follower">
  <figcaption>
    <span class="figura-label">Figura</span>
...
<figure class="figura figura-con-imagen">
  <img src="{{ '/assets/clase-05/logs-divergentes.png' | relative_url }}" alt="Logs con un 4 y un 5 en el mismo índice">
  <figcaption>
    <span class="figura-label">Figura</span>
...
<figure class="figura figura-con-imagen">
  <img src="{{ '/assets/clase-05/dos-lideres-y-falla.png' | relative_url }}" alt="Dos líderes sucesivos que caen dejando logs divergentes">
  <figcaption>
    <span class="figura-label">Figura</span>
