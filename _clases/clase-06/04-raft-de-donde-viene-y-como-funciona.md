...
<figure class="figura figura-codigo">
  <figcaption>
    ...
    los campos del AppendEntries tal como los enumera la figura 2 del paper —term, leaderId, prevLogIndex, prevLogTerm, entries y leaderCommit—, para poder señalar sobre ellos el leaderCommit y las entries de los que habla el párrafo
  </figcaption>
</figure>
