...
<figure class="figura figura-con-imagen">
  <img src="{{ '/assets/clase-06/gfs-append-sin-atomicidad.png' | relative_url }}" alt="Tres réplicas de un chunk con el append fallido en la tercera">
  <figcaption>
...
<figure class="figura figura-con-imagen">
  <img src="{{ '/assets/clase-06/spf-y-split-brain.png' | relative_url }}" alt="El punto único de falla y la cadena hacia el split brain">
  <figcaption>
    <span class="figura-label">Figura</span>
...
<figure class="figura figura-con-imagen">
  <img src="{{ '/assets/clase-06/particion-o-caida.png' | relative_url }}" alt="Diagrama de tiempo de una partición entre dos servidores">
  <figcaption>
    <span class="figura-label">Figura</span>
